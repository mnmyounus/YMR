...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(s: Bundle?) {
        ...
        nav.addOnDestinationChangedListener { _, dest, _ ->
            val hide = dest.id == R.id.lockFragment || dest.id == R.id.setupFragment
            b.bottomNav.visibility = if(hide) View.GONE else View.VISIBLE
            b.appBarLayout.visibility = if(hide) View.GONE else View.VISIBLE
        }
    ...
    override fun onResume() { super.onResume(); b.bannerNotif.visibility = if(isNotifEnabled()) View.GONE else View.VISIBLE }
